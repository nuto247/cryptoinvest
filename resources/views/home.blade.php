...
<div class="container mt-5">
    ...
    <!-- Withdrawal and Profit Information -->
    <div class="row">
        <div class="col-md-6 custom-card mb-3">
            <div class="card card-available-balance">
                <div class="card-body">
        ...
        <div class="col-md-6 custom-card mb-3">
            <div class="card card-available-balance">
                <div class="card-body">
                    ...
                    <p class="card-text">Total Profits</p>
                    <a href="transactions"><button class="btn btn-primary btn-block">View Your Transactions!</button></a>
                </div>
            </div>
        </div>
    </div>
